...
impl Create<wallet_api::AddProposalPolicyOperationInput> for AddProposalPolicyProposalCreate {
    fn create(
        proposal_id: UUID,
        proposed_by_user: UUID,
        input: wallet_api::CreateProposalInput,
        operation_input: wallet_api::AddProposalPolicyOperationInput,
...
mod tests {
    ...
    fn test_create_proposal() {
        ...
        proposal_input.operation =
            wallet_api::ProposalOperationInput::AddProposalPolicy(operation_input.clone());
...
pub mod add_proposal_policy_test_utils {
    pub fn mock_add_proposal_policy_api_input() -> wallet_api::AddProposalPolicyOperationInput {
        wallet_api::AddProposalPolicyOperationInput {
            criteria: wallet_api::CriteriaDTO::AutoAdopted,
            specifier: wallet_api::ProposalSpecifierDTO::AddProposalPolicy,
        }
    }

    pub fn mock_proposal_api_input() -> wallet_api::CreateProposalInput {
        wallet_api::CreateProposalInput {
            operation: wallet_api::ProposalOperationInput::AddProposalPolicy(
