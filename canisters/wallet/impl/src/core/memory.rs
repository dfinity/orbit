...
pub const PROPOSAL_EXPIRATION_TIME_INDEX_MEMORY_ID: MemoryId = MemoryId::new(5);
pub const TRANSFER_ACCOUNT_INDEX_MEMORY_ID: MemoryId = MemoryId::new(6);
pub const PROPOSAL_MEMORY_ID: MemoryId = MemoryId::new(7);
pub const PROPOSAL_ACCOUNT_INDEX_MEMORY_ID: MemoryId = MemoryId::new(8);
pub const PROPOSAL_VOTER_INDEX_MEMORY_ID: MemoryId = MemoryId::new(9);
pub const PROPOSAL_STATUS_INDEX_MEMORY_ID: MemoryId = MemoryId::new(10);
pub const PROPOSAL_SCHEDULED_INDEX_MEMORY_ID: MemoryId = MemoryId::new(11);
pub const NOTIFICATION_MEMORY_ID: MemoryId = MemoryId::new(12);
pub const NOTIFICATION_USER_INDEX_MEMORY_ID: MemoryId = MemoryId::new(13);
pub const TRANSFER_STATUS_INDEX_MEMORY_ID: MemoryId = MemoryId::new(14);
pub const USER_GROUP_MEMORY_ID: MemoryId = MemoryId::new(15);
pub const USER_GROUP_NAME_INDEX_MEMORY_ID: MemoryId = MemoryId::new(16);
pub const PROPOSAL_POLICIES_MEMORY_ID: MemoryId = MemoryId::new(17);
pub const ACCESS_POLICY_MEMORY_ID: MemoryId = MemoryId::new(18);
pub const USER_STATUS_GROUP_INDEX_MEMORY_ID: MemoryId = MemoryId::new(19);
pub const ADDRESS_BOOK_MEMORY_ID: MemoryId = MemoryId::new(20);
pub const ADDRESS_BOOK_INDEX_MEMORY_ID: MemoryId = MemoryId::new(21);
pub const PROPOSAL_PROPOSER_INDEX_MEMORY_ID: MemoryId = MemoryId::new(22);
pub const PROPOSAL_CREATION_TIME_INDEX_MEMORY_ID: MemoryId = MemoryId::new(23);
pub const PROPOSAL_KEY_CREATION_TIME_INDEX_MEMORY_ID: MemoryId = MemoryId::new(24);
pub const PROPOSAL_KEY_EXPIRATION_TIME_INDEX_MEMORY_ID: MemoryId = MemoryId::new(25);
pub const PROPOSAL_SORT_INDEX_MEMORY_ID: MemoryId = MemoryId::new(26);
pub const PROPOSAL_STATUS_MODIFICATION_INDEX_MEMORY_ID: MemoryId = MemoryId::new(27);
pub const NAME_TO_ACCOUNT_ID_INDEX_MEMORY_ID: MemoryId = MemoryId::new(28);
pub const NAME_TO_USER_ID_INDEX_MEMORY_ID: MemoryId = MemoryId::new(29);
