...
pub const PERMISSION_CREATE_PROPOSAL: &str = "create-proposal";
...
pub fn default_wallet_permissions() -> Vec<Permission> {
    vec![
        ...
        Permission {
            permission_id: PERMISSION_CREATE_PROPOSAL.to_string(),
            access_roles: vec![AccessRole::Admin, AccessRole::User],
        },
        Permission {
...
impl Permission {
    pub fn from_dto(permission: WalletPermissionDTO) -> Self {
        Self {
...
impl AccessRole {
    pub fn from_dto(role: UserRoleDTO) -> Self {
        match role {
