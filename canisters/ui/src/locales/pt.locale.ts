export default {
  ...
  proposals: {
    ...
    evaluation: {
      ...
      and_rule: 'Todos os seguintes {n} regras:',
      or_rule: 'Qualquer das seguintes {n} regras:',
      not_rule: 'Não deve passar:',
      has_address_in_address_book: 'Endereço de destino está no livro de endereços',
      not_found_in_address_book: 'Não está no livro de endereços',
      found_in_address_book: 'Está no livro de endereços',
      has_address_book_metadata: 'Endereço de destino tem metadados no livro de endereços',
      address_book_metadata_not_found: 'Não encontrado {metadata}',
      address_book_metadata_found: 'Encontrado: {metadata}',
      minimum_votes: '1 voto mínimo aprovado | {n} votos mínimos aprovados',
      approval_threshold: '1 voto mínimo aprovado | {n} votos mínimos aprovados',
      vote_summary_approved: 'Aprovado com {n} para {m} contra',
      vote_summary_rejected: 'Rejeitado com {n} para {m} contra',
      vote_summary_pending: 'Pendente com {n} para {m} contra',
      vote_comments: '1 comentário | {n} comentários',
      auto_adopted: 'Auto-adotado',
      pending: 'Pendente',
      rejected: 'Rejeitado',
      approved: 'Aprovado',
    },
