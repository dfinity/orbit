export default {
  ...
  proposals: {
    ...
    votes: 'Votes',
    failure_title: 'Proposal execution failed',
    failure_reason_unknown: 'Proposal failed for an unspecified reason.',
    ...
    evaluation: {
      ...
      and_rule: 'All of the following {n} rules:',
      or_rule: 'Any of the following {n} rules:',
      not_rule: 'Must not pass:',
      has_address_in_address_book: 'Dest. address is in Address Book',
      not_found_in_address_book: 'Not in Address Book',
      found_in_address_book: 'In Address Book',
      has_address_book_metadata: 'Dest. address has metadata in Address Book',
      address_book_metadata_not_found: 'Not found {metadata}',
      address_book_metadata_found: 'Found: {metadata}',
      minimum_votes: '1 minimum approving vote | {n} minimum approving votes',
      approval_threshold: '1 minimum approving vote | {n} minimum approving votes',
      vote_summary_approved: 'Approved with {n} for {m} against',
      vote_summary_rejected: 'Rejected with {n} for {m} against',
      vote_summary_pending: 'Pending with {n} for {m} against',
      vote_comments: '1 comment | {n} comments',
