export default {
  ...
  requests: {
    ...
    evaluation: {
      ...
      and_rule: 'Toutes les règles suivantes {n} :',
      or_rule: 'Une des règles suivantes {n} :',
      not_rule: 'Ne doit pas passer :',
      has_address_in_address_book: 'L adresse de destination est dans le carnet d adresses',
      not_found_in_address_book: 'Pas dans le carnet d adresses',
      found_in_address_book: 'Dans le carnet d adresses',
      has_address_book_metadata:
        'L adresse de destination a des métadonnées dans le carnet d adresses',
      address_book_metadata_not_found: 'Non trouvé {metadata}',
      address_book_metadata_found: 'Trouvé : {metadata}',
      minimum_votes: '1 vote approuvant minimum | {n} votes approuvant minimum',
      approval_threshold: '1 vote approuvant minimum | {n} votes approuvant minimum',
      vote_summary_approved: 'Approuvé avec {n} pour {m} contre',
      vote_summary_rejected: 'Rejeté avec {n} pour {m} contre',
      vote_summary_pending: 'En attente avec {n} pour {m} contre',
      vote_comments: '1 commentaire | {n} commentaires',
      auto_adopted: 'Auto-adopté',
      pending: 'En attente',
      rejected: 'Rejeté',
      approved: 'Approuvé',
    },
