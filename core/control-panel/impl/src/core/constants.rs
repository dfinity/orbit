...
/// The amount of cycles to transfer when creating a canister.
/// This must cover canister creation cost in cycles on every possible subnet (except NNS).
pub const CANISTER_CREATION_CYCLES: u128 = 1_500_000_000_000;

/// The initial cycles balance that the upgrader canister should have after its creation.
pub const INITIAL_UPGRADER_CYCLES: u128 = 1_000_000_000_000;

/// The initial cycles balance that the station canister should have after its creation and deploying the upgrader canister.
pub const INITIAL_STATION_CYCLES: u128 = 1_000_000_000_000;
