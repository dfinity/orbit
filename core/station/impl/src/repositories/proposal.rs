...
impl ProposalRepository {
    ...
    fn sort_ids_with_strategy(
        ...
        match sort_by {
            Some(station_api::ListProposalsSortBy::CreatedAt(direction)) => {
            ...
            Some(station_api::ListProposalsSortBy::ExpirationDt(direction)) => {
                let sort_strategy = TimestampSortingStrategy {
                    index: &self.sort_index,
            ...
            Some(station_api::ListProposalsSortBy::LastModificationDt(direction)) => {
                let sort_strategy = TimestampSortingStrategy {
                    index: &self.sort_index,
