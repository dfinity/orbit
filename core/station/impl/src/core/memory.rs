...
pub const PROPOSAL_VOTER_INDEX_MEMORY_ID: MemoryId = MemoryId::new(8);
pub const PROPOSAL_STATUS_INDEX_MEMORY_ID: MemoryId = MemoryId::new(9);
pub const PROPOSAL_SCHEDULED_INDEX_MEMORY_ID: MemoryId = MemoryId::new(10);
...
pub const PROPOSAL_POLICIES_MEMORY_ID: MemoryId = MemoryId::new(16);
pub const ACCESS_POLICY_MEMORY_ID: MemoryId = MemoryId::new(17);
...
pub const PROPOSAL_PROPOSER_INDEX_MEMORY_ID: MemoryId = MemoryId::new(21);
pub const PROPOSAL_CREATION_TIME_INDEX_MEMORY_ID: MemoryId = MemoryId::new(22);
pub const PROPOSAL_KEY_CREATION_TIME_INDEX_MEMORY_ID: MemoryId = MemoryId::new(23);
pub const PROPOSAL_KEY_EXPIRATION_TIME_INDEX_MEMORY_ID: MemoryId = MemoryId::new(24);
pub const PROPOSAL_SORT_INDEX_MEMORY_ID: MemoryId = MemoryId::new(25);
pub const PROPOSAL_STATUS_MODIFICATION_INDEX_MEMORY_ID: MemoryId = MemoryId::new(26);
...
pub const OPERATION_TYPE_TO_PROPOSAL_ID_INDEX_MEMORY_ID: MemoryId = MemoryId::new(29);
pub const PROPOSAL_RESOURCE_INDEX_MEMORY_ID: MemoryId = MemoryId::new(30);
pub const POLICY_RESOURCE_INDEX_MEMORY_ID: MemoryId = MemoryId::new(31);
pub const EVALUATION_RESULT_MEMORY_ID: MemoryId = MemoryId::new(32);
