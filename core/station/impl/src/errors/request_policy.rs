...
impl From<AssetValidationError> for RequestPolicyError {
    fn from(err: AssetValidationError) -> RequestPolicyError {
        match err {
            AssetValidationError::ImmutableField { field } => RequestPolicyError::ValidationError {
