    ...
    pub async fn create_proposal(
        ...
        match &input.operation {
            ProposalOperationInput::Transfer(operation) => {
                create_proposal::<station_api::TransferOperationInput, TransferProposalCreate>(
                    id,
                    proposed_by_user,
                    input.clone(),
                    operation.clone(),
            ...
            ProposalOperationInput::AddAccount(operation) => {
                create_proposal::<station_api::AddAccountOperationInput, AddAccountProposalCreate>(
                    id,
                    proposed_by_user,
                    input.clone(),
                    operation.clone(),
            ...
            ProposalOperationInput::EditAccount(operation) => {
                create_proposal::<station_api::EditAccountOperationInput, EditAccountProposalCreate>(
                    id,
                    proposed_by_user,
                    input.clone(),
                    operation.clone(),
            ...
            ProposalOperationInput::AddUserGroup(operation) => {
                create_proposal::<station_api::AddUserGroupOperationInput, AddUserGroupProposalCreate>(
                    id,
                    proposed_by_user,
                    input.clone(),
                    operation.clone(),
            ...
            ProposalOperationInput::AddUser(operation) => {
                create_proposal::<station_api::AddUserOperationInput, AddUserProposalCreate>(
                    id,
                    proposed_by_user,
                    input.clone(),
                    operation.clone(),
            ...
            ProposalOperationInput::EditUser(operation) => {
                create_proposal::<station_api::EditUserOperationInput, EditUserProposalCreate>(
                    id,
                    proposed_by_user,
                    input.clone(),
                    operation.clone(),
