...
impl Create<station_api::RemoveProposalPolicyOperationInput>
    for RemoveProposalPolicyProposalCreate
{
    fn create(
        proposal_id: UUID,
        proposed_by_user: UUID,
        input: station_api::CreateProposalInput,
        operation_input: station_api::RemoveProposalPolicyOperationInput,
...
mod tests {
    ...
    fn test_create_proposal() {
        ...
        proposal_input.operation =
            station_api::ProposalOperationInput::RemoveProposalPolicy(operation_input.clone());
...
pub mod remove_proposal_policy_test_utils {
    ...
    pub fn mock_remove_proposal_policy_api_input() -> station_api::RemoveProposalPolicyOperationInput
    {
    ...
    pub fn mock_proposal_api_input() -> station_api::CreateProposalInput {
        station_api::CreateProposalInput {
            operation: station_api::ProposalOperationInput::RemoveProposalPolicy(
