...
impl Create<station_api::EditProposalPolicyOperationInput> for EditProposalPolicyProposalCreate {
    fn create(
        proposal_id: UUID,
        proposed_by_user: UUID,
        input: station_api::CreateProposalInput,
        operation_input: station_api::EditProposalPolicyOperationInput,
...
mod tests {
    ...
    fn test_create_proposal() {
        ...
        proposal_input.operation =
            station_api::ProposalOperationInput::EditProposalPolicy(operation_input.clone());
...
pub mod edit_proposal_policy_test_utils {
    ...
    pub fn mock_edit_proposal_policy_api_input() -> station_api::EditProposalPolicyOperationInput {
        station_api::EditProposalPolicyOperationInput {
            policy_id: Uuid::from_bytes([0u8; 16]).hyphenated().to_string(),
            criteria: Some(station_api::CriteriaDTO::AutoAdopted),
            specifier: Some(station_api::ProposalSpecifierDTO::EditProposalPolicy(
    ...
    pub fn mock_proposal_api_input() -> station_api::CreateProposalInput {
        station_api::CreateProposalInput {
            operation: station_api::ProposalOperationInput::EditProposalPolicy(
