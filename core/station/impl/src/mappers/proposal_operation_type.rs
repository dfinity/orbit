...
use station_api::{ListProposalsOperationTypeDTO, ProposalOperationTypeDTO};
...
impl From<station_api::ListProposalsOperationTypeDTO> for ProposalOperationFilterType {
    fn from(dto: station_api::ListProposalsOperationTypeDTO) -> Self {
        match dto {
            station_api::ListProposalsOperationTypeDTO::Transfer(from_account_id) => {
            ...
            station_api::ListProposalsOperationTypeDTO::AddAccount => {
                ProposalOperationFilterType::AddAccount
            }
            station_api::ListProposalsOperationTypeDTO::EditAccount => {
                ProposalOperationFilterType::EditAccount
            }
            station_api::ListProposalsOperationTypeDTO::AddAddressBookEntry => {
                ProposalOperationFilterType::AddAddressBookEntry
            }
            station_api::ListProposalsOperationTypeDTO::EditAddressBookEntry => {
                ProposalOperationFilterType::EditAddressBookEntry
            }
            station_api::ListProposalsOperationTypeDTO::RemoveAddressBookEntry => {
                ProposalOperationFilterType::RemoveAddressBookEntry
            }
            station_api::ListProposalsOperationTypeDTO::AddUser => {
                ProposalOperationFilterType::AddUser
            }
            station_api::ListProposalsOperationTypeDTO::EditUser => {
                ProposalOperationFilterType::EditUser
            }
            station_api::ListProposalsOperationTypeDTO::AddUserGroup => {
                ProposalOperationFilterType::AddUserGroup
            }
            station_api::ListProposalsOperationTypeDTO::EditUserGroup => {
                ProposalOperationFilterType::EditUserGroup
            }
            station_api::ListProposalsOperationTypeDTO::RemoveUserGroup => {
            ...
            station_api::ListProposalsOperationTypeDTO::EditProposalPolicy => {
                ProposalOperationFilterType::EditProposalPolicy
            }
            station_api::ListProposalsOperationTypeDTO::RemoveProposalPolicy => {
