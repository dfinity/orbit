...
use station_api::{ProposalDTO, ProposalExecutionScheduleDTO};
use uuid::Uuid;
...
impl From<ProposalCallerPrivileges> for station_api::ProposalCallerPrivilegesDTO {
...
impl From<ProposalAdditionalInfo> for station_api::ProposalAdditionalInfoDTO {
