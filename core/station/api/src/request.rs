...
use crate::{
    ...
    AddUserOperationDTO, AddUserOperationInput, CallCanisterOperationDTO,
    CallCanisterOperationInput, ChangeCanisterOperationDTO, ChangeCanisterOperationInput,
    ChangeManagedCanisterOperationDTO, ChangeManagedCanisterOperationInput,
    CreateManagedCanisterOperationDTO, CreateManagedCanisterOperationInput, DisplayUserDTO,
...
pub enum RequestOperationDTO {
    ...
    CallCanister(Box<CallCanisterOperationDTO>),
